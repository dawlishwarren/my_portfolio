...
export const languageSkills = [
	...
	},
	{
		...
		text: 'Learnt while wanting to become a more well-rounded developer.',
	},
	{
		name: 'PHP',
		icon: DiPhp,
...
export const databaseSkills = [
	...
	},
	{
		...
		when: 2022,
		where: 'PHP & MySQL for Dynamic Web Sites (Larry Ullman).',
		text: 'Experienced configuring both MAMP and XAMPP in the development of php-driven apps.',
	},
];
// Testing/Planning
export const testingPlanningSkills = [
	{
		name: 'GitHub',
		icon: DiGithubFull,
		when: 2021,
