					...
					<div className={styles.content}>
						<div className={styles.columns}>
							<div className={styles.column}>
								...
								<p className={`${styles.primary} ${getCategoryColor("plan")}`}>
									Failing to prepare:
								</p>
							...
							<div className={styles.column}>
								<h1 className={`${styles.title} ${getCategoryColor("design")}`}>
									Designer
								</h1>
								<p>
								...
								<p
									className={`${styles.primary} ${getCategoryColor("design")}`}>
							...
							<div className={styles.column}>
								<h1 className={`${styles.title} ${getCategoryColor("build")}`}>
									Builder
								</h1>
								<p>
								...
								<p className={`${styles.primary} ${getCategoryColor("build")}`}>
									I speak:
								</p>
